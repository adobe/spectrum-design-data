 ...
 * @property {boolean} [prerendered] If true, render.mjs skips VHS and expects
 *                                   the clip to already exist at out/<slug>-<id>.mp4
 *                                   (generated by the manifest's prebuild commands).
 *
