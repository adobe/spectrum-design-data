...
- SDK: new `spec035.rs` rule using the existing `for_field("anatomy")` accessor on `RegistryData`
- `spec/anatomy-format.md` — extends SPEC rules table; adds note pointing to registry as authoritative vocabulary
