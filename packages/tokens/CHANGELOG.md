...
- [`cc3b3ea`](https://github.com/adobe/spectrum-design-data/commit/cc3b3ea8bb575f334dd993592ffffed06eeb4c3d) Thanks [@GarthDB](https://github.com/GarthDB)! - Re-apply 100 spec-order token renames from PR #814 gap analysis.
  ...
  - **semantic-color-palette.json**: 5 tokens deprecated
    (icon-color-_ → _-icon-color spec ordering).
