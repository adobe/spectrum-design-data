...
const COLOR_FAMILIES_JSON: &str = r##"{
  ...
  "values": [
    ...
    {
      "id": "transparent-neutral",
      "label": "Transparent Neutral",
      "description": "Theme-aware transparent color family: black-based in Light/Wireframe, white-based in Dark"
    },
    {
      "id": "transparent-neutral-inverse",
      "label": "Transparent Neutral Inverse",
      "description": "Theme-aware transparent color family: white-based in Light/Wireframe, black-based in Dark"
    },
    {
      "id": "transparent-static-black",
      "label": "Transparent Static Black",
      "description": "Black-based transparent color family that remains fixed in all color schemes, aligned to the opacity foundation scale"
    },
    {
      "id": "transparent-static-white",
      "label": "Transparent Static White",
      "description": "White-based transparent color family that remains fixed in all color schemes, aligned to the opacity foundation scale"
    },
    {
...
pub(crate) fn build_registry_map(
    ...
    map.insert("typography-families".to_string(), parse_registry(TYPOGRAPHY_FAMILIES_JSON));
    map.insert("emphasis".to_string(), parse_registry(TYPOGRAPHY_EMPHASIS_JSON));
    map.insert("typography-emphasis".to_string(), parse_registry(TYPOGRAPHY_EMPHASIS_JSON));
    map.insert("property".to_string(), parse_registry(PROPERTY_TERMS_JSON));
    map.insert("property-terms".to_string(), parse_registry(PROPERTY_TERMS_JSON));
    map.insert("orientation".to_string(), parse_registry(ORIENTATIONS_JSON));
    map.insert("orientations".to_string(), parse_registry(ORIENTATIONS_JSON));
    map.insert("position".to_string(), parse_registry(POSITIONS_JSON));
    map.insert("positions".to_string(), parse_registry(POSITIONS_JSON));
    map.insert("size".to_string(), parse_registry(SIZES_JSON));
    map.insert("sizes".to_string(), parse_registry(SIZES_JSON));
    ...
    map.insert("typography-weights".to_string(), parse_registry(TYPOGRAPHY_WEIGHTS_JSON));
    map.insert("style".to_string(), parse_registry(TYPOGRAPHY_STYLES_JSON));
    map.insert("typography-styles".to_string(), parse_registry(TYPOGRAPHY_STYLES_JSON));
    map.insert("motionRole".to_string(), parse_registry(MOTION_ROLES_JSON));
    map.insert("motion-roles".to_string(), parse_registry(MOTION_ROLES_JSON));
    map.insert("easing".to_string(), parse_registry(EASING_CURVES_JSON));
    map.insert("easing-curves".to_string(), parse_registry(EASING_CURVES_JSON));
