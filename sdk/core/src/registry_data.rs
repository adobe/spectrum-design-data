...
const COLOR_FAMILIES_JSON: &str = r##"{
  ...
  "values": [
    ...
    },
    {
      ...
      "description": "Theme-aware transparent family: black-based in Light/Wireframe, white-based in Dark"
    },
    {
      "id": "transparent-neutral-inverse",
      "label": "Transparent Neutral Inverse",
      "description": "Theme-aware transparent family, inverted: white-based in Light/Wireframe, black-based in Dark"
    },
    {
      "id": "transparent-static-black",
      "label": "Transparent Static Black",
      "description": "Black-based transparent color family with values fixed across all color schemes, built on the opacity scale"
    },
    {
      "id": "transparent-static-white",
      "label": "Transparent Static White",
      "description": "White-based transparent color family with values fixed across all color schemes, built on the opacity scale"
    },
    {
